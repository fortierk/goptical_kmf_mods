...
/* dime DXF rendering library enabled */
/* #undef GOPTICAL_HAVE_DIME */

/* gd rendering library enabled */
...
/* Name of package */
#define PACKAGE "goptical_core"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT ""

/* Define to the full name of this package. */
#define PACKAGE_NAME "goptical_core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "goptical_core 1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "goptical_core"
