#ifndef SOURCE_OBJ_NA_HH
#define SOURCE_OBJ_NA_HH
...
namespace _Goptical {
  ...
  namespace Sys {
      ...
      /**
         ...
         @header Goptical/Sys/SourceObjNA
         @module {Core}
         @main

         This class implement a light source based on a user defined
         numerical aperature.

         Default wavelen list contains a single 550nm entry.
      */

    class SourceObjNA : public Source
    {
    public:
      /** Create a rays source. Source object position is used by some
          of the @tt add_* functions and may be specified. */
      SourceObjNA(const Math::Vector3 &object = Math::vector3_0);
      SourceObjNA(const Math::Vector3 &object = Math::vector3_0);
