...
#ifndef GOPTICAL_MATH_VECTORPAIR_EIGEN_HXX_
#define GOPTICAL_MATH_VECTORPAIR_EIGEN_HXX_
...
namespace _Goptical {
  ...
  namespace Math {
    ...
    template <int N>
    VectorPairBase<N>::VectorPairBase(const Eigen::VectorXf &first, const Eigen::VectorXf<N> &second)
    {
      _v[0] = first;
      _v[1] = second;
    }
    ...
    template <int N>
    const Eigen::VectorXf<N> & VectorPairBase<N>::operator[](int n) const
    {
      return _v[n];
    }

    template <int N>
    Eigen::VectorXf<N> & VectorPairBase<N>::operator[](int n)
    {
      return _v[n];
    }
    ...
    template <int N> MyVector & VectorPairBase<N>::origin() const
    {
      return _v[0];
    }
